...
class ItineraryService {
  ...
  static async list(params) {
    const list = await ItineraryModel.list(params.arrival.toUpperCase(), params.departure.toUpperCase());
  ...
  static async arrival(params) {
    const list = await ItineraryModel.arrival(params.arrival.toUpperCase());
